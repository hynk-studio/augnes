...
const defaultForbiddenCapabilities = [
  ...
  "No Git branch/commit/PR creation from Augnes runtime.",
...
const forbiddenAuthorityPhrasePatterns = [
  /\bgit ledger export packet\s+(?:is|=|as)\s+(?!not\b)(?:git commit|commit|git write approval|github actuation|pr creation|release approval|deploy approval|publish approval|truth|proof|accepted evidence|approval|authority)\b/i,
  /\bsuggested commit message\s+(?:is|=|as)\s+(?!not\b)(?:approval|commit approval|execution approval|authority|git write approval)\b/i,
  /\bsuggested commit intent\s+(?:is|=|as)\s+(?!not\b)(?:execution approval|approval|authority|git write approval)\b/i,
  /\bpacket hash\s+(?:is|=|as)\s+(?!not\b)(?:truth|proof|approval|authority|accepted evidence)\b/i,
  /\bidempotency key\s+(?:is|=|as)\s+(?!not\b)(?:approval|authority|truth|proof|accepted evidence)\b/i,
  /\blocal data export manifest\s+(?:is|=|as)\s+(?!not\b)(?:export file|import approval|truth|proof|accepted evidence|approval|authority)\b/i,
  /\bmanifest fingerprint\s+(?:is|=|as)\s+(?!not\b)(?:proof|approval|truth|authority|accepted evidence)\b/i,
  /\bmanifest status\s+(?:is|=|as)\s+(?!not\b)(?:product readiness|release readiness|approval|authority|truth|proof)\b/i,
  ...
  /\bci pass\s+(?:is|=|as)\s+(?!not\b)(?:truth|proof|approval|authority|release approval|product readiness)\b/i,
