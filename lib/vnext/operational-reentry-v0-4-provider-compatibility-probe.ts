...
import {
  ...
  OPERATIONAL_REENTRY_V04_PROVIDER_COMPATIBILITY_PROBE_MANIFEST_VERSION_V01,
  OPERATIONAL_REENTRY_V04_PROVIDER_COMPATIBILITY_PROBE_PLAN_VERSION_V01,
  OPERATIONAL_REENTRY_V04_PROVIDER_COMPATIBILITY_PROBE_PRICING_VERSION_V01,
  OPERATIONAL_REENTRY_V04_PROVIDER_COMPATIBILITY_PROBE_REPORT_VERSION_V01,
  ...
  type OperationalReentryV04ProviderCompatibilityProbeExecutionResultV01,
  type OperationalReentryV04ProviderCompatibilityProbeOutcomeV01,
  type OperationalReentryV04ProviderCompatibilityProbePlanArtifactEntryV01,
  type OperationalReentryV04ProviderCompatibilityProbePlanEntryV01,
  type OperationalReentryV04ProviderCompatibilityProbePlanV01,
  type OperationalReentryV04ProviderCompatibilityProbePreparedV01,
  type OperationalReentryV04ProviderCompatibilityProbePricingV01,
  type OperationalReentryV04ProviderCompatibilityProbeProviderContractV01,
  type OperationalReentryV04ProviderCompatibilityProbeReportV01,
  type OperationalReentryV04ProviderCompatibilityProbeRepresentativeShapePlanV01,
  type OperationalReentryV04ProviderCompatibilityProbeShapeTerminalV01,
  type OperationalReentryV04ProviderCompatibilityProbeShapeV01,
  type OperationalReentryV04ProviderCompatibilityProbeTerminalCategoryV01,
} from "@/types/vnext/operational-reentry-v0-4-provider-compatibility-probe";

export const ACGC_E2R2P6C_ISSUE_NUMBER_V01 = 229 as const;
export const ACGC_E2R2P6B_MERGE_SHA_V01 =
  "e1c6aa46960bf3d983818faba0d9531d3e3333fa" as const;
export const ACGC_E2R2P6B_TREE_SHA_V01 =
  "094f7b6d061b7626b00c331424bc77d06b9de147" as const;
export const ACGC_E2R2P6C_CANONICAL_SHAPE_ORDER_V01 = Object.freeze([
  "A",
  "B",
  "C",
  "D",
] as const);
export const ACGC_E2R2P6C_PROVIDER_CONTRACT_FINGERPRINT_V01 =
  "sha256:1ca7da7cf3870de67fdbe36f1a6bf9d67a3a50accbd8f7daf147e424901eda52" as const;
export const ACGC_E2R2P6C_ROUTE_FINGERPRINT_V01 =
  "sha256:1d53d6d1b8ae9480542284718e662cb164cfb49284d6be20230b233c5d1d625f" as const;
export const ACGC_E2R2P6C_ADAPTER_REQUEST_ROUTE_FINGERPRINT_V01 =
  "sha256:7418f3ace51f53a8089c33392dc00d697f21ab383a4c4442fc4ffdc39efea0fa" as const;
export const ACGC_E2R2P6C_AGGREGATE_COST_CEILING_NANO_USD_V01 =
  250_000_000 as const;
export const ACGC_E2R2P6C_AGGREGATE_WORST_CASE_COST_NANO_USD_V01 =
  (OPERATIONAL_REENTRY_MATCHED_COHORT_MODEL_EGRESS_LIMITS_V04.finalRequestBytes *
    ...
    OPERATIONAL_REENTRY_MATCHED_COHORT_MODEL_EGRESS_LIMITS_V04.maxOutputTokens *
      1_600) *
  4;
export const ACGC_E2R2P6C_PRICING_EFFECTIVE_AT_V01 =
  "2026-08-22T00:00:00.000Z" as const;
export const ACGC_E2R2P6C_PRICING_EXPIRES_AT_V01 =
  "2026-08-29T00:00:00.000Z" as const;
export const ACGC_E2R2P6C_PROBE_OUTCOMES_V01 = Object.freeze([
  "accepted_all_shapes",
  "provider_rejected",
...
export const ACGC_E2R2P6C_TERMINAL_CATEGORIES_V01 = Object.freeze([
...
export const operationalReentryV04ProviderCompatibilityProbeHarnessAuthorityV01 =
  Object.freeze({
...
export class OperationalReentryV04ProviderCompatibilityProbeErrorV01 extends Error {
  constructor(readonly code: string) {
    super(code);
    this.name =
      "OperationalReentryV04ProviderCompatibilityProbeErrorV01";
  }
}

export interface BuildOperationalReentryV04ProviderCompatibilityProbeInputV01 {
...
export interface RunOperationalReentryV04ProviderCompatibilityProbeDependenciesV01 {
  ...
  assert_source_unchanged: (
    entry: OperationalReentryV04ProviderCompatibilityProbePlanEntryV01,
  ) => void | Promise<void>;
...
export interface OperationalReentryV04ProviderCompatibilityProbeAuthorizationExpectationsV01 {
  repository_slug: typeof AUTHORIZED_REPOSITORY_SLUG_V01;
  authorized_origin:
    "https://github.com/hynk-studio/augnes.git";
  workspace_id: string;
...
export function buildOperationalReentryV04ProviderCompatibilityProbeRepresentativeShapePlanV01(
  caseInput: OperationalReentryMatchedCohortCaseV02 =
    operationalReentryMatchedCohortCaseFixtureV02,
): OperationalReentryV04ProviderCompatibilityProbeRepresentativeShapePlanV01 {
  assertSealedV01(caseInput);
  const entries = ACGC_E2R2P6C_CANONICAL_SHAPE_ORDER_V01.map(
    (shape, canonicalOrder) => {
      const callSlotId = `e2r2p6c-call-${String(canonicalOrder).padStart(2, "0")}-${fingerprintV01({
        family: "operational_reentry_v04_compatibility_probe",
      ...
      const invocation = buildOperationalReentryMatchedCohortInvocationV04({
        ...
        arm: shape,
        cohort_ref: "acgc-e2r2p6c-v04-compatibility",
        block: 0,
      ...
      return {
        ...
        route_fingerprint: ACGC_E2R2P6C_ROUTE_FINGERPRINT_V01,
        provider_contract_fingerprint:
          ACGC_E2R2P6C_PROVIDER_CONTRACT_FINGERPRINT_V01,
  ...
  const leftB = entries[1]!;
  const leftBRequest =
    projectOperationalReentryMatchedCohortProviderRequestV04(
      leftB.invocation,
    );
  const twinB = buildOperationalReentryMatchedCohortInvocationV04({
    case_input: caseInput,
    arm: "B",
    cohort_ref: "acgc-e2r2p6c-v04-compatibility-twin",
    block: 3,
    call_slot_id: "e2r2p6c-static-twin-b",
  });
  const twinBRequest =
    projectOperationalReentryMatchedCohortProviderRequestV04(twinB);
  const leftBBody = JSON.parse(leftBRequest.request_body) as {
    input: unknown[];
    text: { format: { schema: unknown } };
  };
  const twinBBody = JSON.parse(twinBRequest.request_body) as typeof leftBBody;
  const twinBLocalFingerprint =
    createOperationalReentryMatchedCohortLocalInvocationIdentityFingerprintV04(
      twinB,
    );
  const twinBTraceIds = [
    leftB.local_invocation_identity_fingerprint,
    twinBLocalFingerprint,
  ].map((requestFamilyFingerprint) =>
    createDeterministicModelProviderRequestTraceV01({
      request_family_kind: "operational_reentry_v04_compatibility_probe",
      request_family_fingerprint: requestFamilyFingerprint,
    }),
  );
  const twinBClientRequestIds = twinBTraceIds.map((trace, index) =>
    createDeterministicModelClientRequestIdV01({
      purpose: OPERATIONAL_REENTRY_MATCHED_COHORT_V04_MODEL_GATEWAY_PURPOSE_V01,
      provider_request_trace_id: trace,
      call_slot_id:
        index === 0 ? leftB.call_slot_id : twinB.local_invocation_context.call_slot_id,
      model: twinBRequest.model,
    }),
  );
  if (
    leftB.invocation.local_invocation_context.cohort_ref ===
      twinB.local_invocation_context.cohort_ref ||
    leftB.invocation.local_invocation_context.call_slot_id ===
      twinB.local_invocation_context.call_slot_id ||
    leftB.invocation.local_invocation_context.repeat_block ===
      twinB.local_invocation_context.repeat_block ||
    leftB.local_invocation_identity_fingerprint === twinBLocalFingerprint ||
    leftB.provider_material_fingerprint !==
      createOperationalReentryMatchedCohortProviderMaterialFingerprintV04(
        twinB.provider_material,
      ) ||
    leftB.provider_visible_request_fingerprint !==
      twinBRequest.request_fingerprint ||
    leftBRequest.request_body !== twinBRequest.request_body ||
    canonicalizeProtocolValueV01(leftBBody.input[0]) !==
      canonicalizeProtocolValueV01(twinBBody.input[0]) ||
    canonicalizeProtocolValueV01(leftBBody.input[1]) !==
      canonicalizeProtocolValueV01(twinBBody.input[1]) ||
    canonicalizeProtocolValueV01(leftBBody.text.format.schema) !==
      canonicalizeProtocolValueV01(twinBBody.text.format.schema) ||
    leftB.schema_fingerprint !== twinBRequest.schema_fingerprint ||
    leftB.route_fingerprint !== ACGC_E2R2P6C_ROUTE_FINGERPRINT_V01 ||
    leftB.provider_contract_fingerprint !==
      ACGC_E2R2P6C_PROVIDER_CONTRACT_FINGERPRINT_V01 ||
    leftB.adapter_request_route_fingerprint !==
      twinBRequest.adapter_request_route_fingerprint ||
    new Set(twinBTraceIds).size !== 2 ||
    new Set(twinBClientRequestIds).size !== 2
  ) {
    failV01("operational_reentry_v04_probe_twin_b_witness_invalid");
  }
  return sealV01("operational_reentry_v04_representative_shape_plan_without_integrity_fingerprint", {
    representative_plan_version:
      "operational_reentry_v04_representative_shape_plan.v0.1" as const,
    case_fingerprint: caseInput.integrity.fingerprint,
    common_task_evidence_fingerprint:
      OPERATIONAL_REENTRY_MATCHED_COHORT_COMMON_TASK_EVIDENCE_FINGERPRINT_V02,
    canonical_order: ACGC_E2R2P6C_CANONICAL_SHAPE_ORDER_V01,
    entries,
    twin_b_identity_separation_witness: sealV01(
      "operational_reentry_v04_twin_b_witness_without_integrity_fingerprint",
      {
        left_local_invocation_identity_fingerprint:
          leftB.local_invocation_identity_fingerprint,
        right_local_invocation_identity_fingerprint: twinBLocalFingerprint,
        provider_material_fingerprint: leftB.provider_material_fingerprint,
        provider_visible_request_fingerprint:
          leftB.provider_visible_request_fingerprint,
        schema_fingerprint: leftB.schema_fingerprint,
        route_fingerprint: leftB.route_fingerprint,
        provider_contract_fingerprint: leftB.provider_contract_fingerprint,
        adapter_request_route_fingerprint:
          leftB.adapter_request_route_fingerprint,
        cohort_refs_distinct: true as const,
        call_slot_ids_distinct: true as const,
        repeat_blocks_distinct: true as const,
        local_plan_identities_distinct: true as const,
        canonical_system_prompt_equal: true as const,
        canonical_user_material_equal: true as const,
        canonical_schema_equal: true as const,
        canonical_openai_json_request_body_bytes_equal: true as const,
        request_body_fingerprints_equal: true as const,
        route_model_adapter_budget_identities_equal: true as const,
        exact_provider_body_equal: true as const,
...
export function buildOperationalReentryV04ProviderCompatibilityProbeProviderContractV01(
  route: OperationalReentryMatchedCohortRouteV04,
): OperationalReentryV04ProviderCompatibilityProbeProviderContractV01 {
  ...
  if (route.provider_contract_fingerprint !== contract.integrity.fingerprint) {
    failV01("operational_reentry_v04_probe_provider_contract_mismatch");
  }
  return structuredClone(contract);
}

export function buildOperationalReentryV04ProviderCompatibilityProbePricingV01(
  input: {
    admission: ModelGatewayInteractiveAdmissionV01;
    route: OperationalReentryMatchedCohortRouteV04;
    evaluated_at: string;
  },
): OperationalReentryV04ProviderCompatibilityProbePricingV01 {
  ...
  const authority = buildModelGatewayCostAuthorityV01({
    ...
    pricing_effective_at: ACGC_E2R2P6C_PRICING_EFFECTIVE_AT_V01,
    pricing_expires_at: ACGC_E2R2P6C_PRICING_EXPIRES_AT_V01,
  ...
  if (
    ...
    failV01("operational_reentry_v04_probe_aggregate_cost_ceiling_exceeded");
  }
  return sealV01("operational_reentry_v04_probe_pricing_without_integrity_fingerprint", {
    pricing_version:
      OPERATIONAL_REENTRY_V04_PROVIDER_COMPATIBILITY_PROBE_PRICING_VERSION_V01,
...
export function buildOperationalReentryV04ProviderCompatibilityProbeAuthorizationExpectationsV01(
  input: Omit<BuildOperationalReentryV04ProviderCompatibilityProbeInputV01, "authorization">,
): OperationalReentryV04ProviderCompatibilityProbeAuthorizationExpectationsV01 {
  ...
  const providerContract =
    buildOperationalReentryV04ProviderCompatibilityProbeProviderContractV01(
      input.route,
    );
  const pricing =
    buildOperationalReentryV04ProviderCompatibilityProbePricingV01(
      input,
    );
  return {
    ...
    twin_b_zero_egress_witness_fingerprint:
      representativeShapePlan.twin_b_identity_separation_witness.integrity
        .fingerprint,
    route_fingerprint: input.route.integrity_fingerprint,
...
export function validateOperationalReentryV04ProviderCompatibilityProbeAuthorizationV01(
  value: unknown,
  input: Omit<BuildOperationalReentryV04ProviderCompatibilityProbeInputV01, "authorization">,
): OperationalReentryV04ProviderCompatibilityProbeAuthorizationV01 {
  if (!isRecordV01(value)) {
    failV01("operational_reentry_v04_probe_authorization_missing_or_malformed");
  }
  exactKeysV01(value, [
  ...
  if (
    ...
    authorization.future_live_issue_number <= ACGC_E2R2P6C_ISSUE_NUMBER_V01 ||
    !GIT_SHA_V01.test(authorization.exact_merged_source_head) ||
    authorization.exact_merged_source_head === ACGC_E2R2P6B_MERGE_SHA_V01 ||
    authorization.exact_merged_source_head === ACGC_E2R2P6B_TREE_SHA_V01 ||
    ...
    authorization.final_request_bytes !== expectations.final_request_bytes ||
    ...
    failV01("operational_reentry_v04_probe_authorization_mismatched");
  }
  return authorization;
}

export function buildOperationalReentryV04ProviderCompatibilityProbeV01(
  input: BuildOperationalReentryV04ProviderCompatibilityProbeInputV01,
): OperationalReentryV04ProviderCompatibilityProbePreparedV01 {
  const authorization =
    validateOperationalReentryV04ProviderCompatibilityProbeAuthorizationV01(
      input.authorization,
      input,
    );
  ...
  const entries: OperationalReentryV04ProviderCompatibilityProbePlanEntryV01[] =
  ...
  const plan = sealV01("operational_reentry_v04_probe_plan_without_integrity_fingerprint", {
    plan_version:
      OPERATIONAL_REENTRY_V04_PROVIDER_COMPATIBILITY_PROBE_PLAN_VERSION_V01,
    authorization_fingerprint: authorization.integrity.fingerprint,
    ...
    request_family_kind: "operational_reentry_v04_compatibility_probe" as const,
    request_family_basis_fingerprint: requestFamilyBasisFingerprint,
    representative_shape_plan_fingerprint:
      representativeShapePlan.integrity.fingerprint,
    canonical_order: ACGC_E2R2P6C_CANONICAL_SHAPE_ORDER_V01,
  ...
  const probeId =
    `operational-reentry-v04-provider-probe:${fingerprintV01({
      authorization_fingerprint: authorization.integrity.fingerprint,
      plan_fingerprint: plan.integrity.fingerprint,
    }).slice("sha256:".length, "sha256:".length + 32)}`;
  const manifest = sealV01(
    "operational_reentry_v04_probe_manifest_without_integrity_fingerprint",
    {
      manifest_version:
        OPERATIONAL_REENTRY_V04_PROVIDER_COMPATIBILITY_PROBE_MANIFEST_VERSION_V01,
      probe_version:
      ...
      response_invalid_observation_version:
        MODEL_PROVIDER_RESPONSE_INVALID_OBSERVATION_VERSION_V01,
      response_bytes:
        OPERATIONAL_REENTRY_MATCHED_COHORT_MODEL_EGRESS_LIMITS_V04.responseBytes as 1168,
      max_output_tokens:
        OPERATIONAL_REENTRY_MATCHED_COHORT_MODEL_EGRESS_LIMITS_V04.maxOutputTokens as 1168,
      final_request_bytes:
        OPERATIONAL_REENTRY_MATCHED_COHORT_MODEL_EGRESS_LIMITS_V04.finalRequestBytes as 24576,
      pricing_fingerprint: pricing.integrity.fingerprint,
      pricing_authority_fingerprint:
        pricing.gateway_cost_budget.authority.pricing_fingerprint,
      request_family_kind: "operational_reentry_v04_compatibility_probe" as const,
...
export async function runOperationalReentryV04ProviderCompatibilityProbeV01(
  input: BuildOperationalReentryV04ProviderCompatibilityProbeInputV01,
  dependencies: RunOperationalReentryV04ProviderCompatibilityProbeDependenciesV01,
): Promise<OperationalReentryV04ProviderCompatibilityProbeExecutionResultV01> {
  if (
    !dependencies ||
    typeof dependencies.assert_source_unchanged !== "function" ||
    typeof dependencies.consume_authorization !== "function"
  ) {
    failV01("operational_reentry_v04_probe_runtime_dependencies_missing");
  }
  const prepared =
    buildOperationalReentryV04ProviderCompatibilityProbeV01(input);
  const invokeGateway =
    dependencies.invoke_gateway ??
    invokeOperationalReentryMatchedCohortModelGatewayV04;
  const cancellation =
    dependencies.cancellation_signal ?? new AbortController().signal;
  const shapes: OperationalReentryV04ProviderCompatibilityProbeShapeTerminalV01[] =
    [];
  ...
  for (const entry of prepared.plan.entries) {
    ...
    let terminal: OperationalReentryV04ProviderCompatibilityProbeShapeTerminalV01;
    try {
      const result = await invokeGateway(
        ...
        ),
        {
          ...
          expected_operational_reentry_matched_cohort_v04_route:
      ...
      if (
        ...
        failV01("operational_reentry_v04_probe_deterministic_or_unobserved_success_refused");
      }
  ...
  return validateOperationalReentryV04ProviderCompatibilityProbeExecutionResultV01(
    {
      result_kind:
...
export function deriveOperationalReentryV04ProviderCompatibilityProbeOutcomeV01(
  categories: OperationalReentryV04ProviderCompatibilityProbeTerminalCategoryV01[],
  sourceUnchangedAtTerminal = true,
): OperationalReentryV04ProviderCompatibilityProbeOutcomeV01 {
...
export function projectOperationalReentryV04ProviderCompatibilityProbePlanForArtifactV01(
  plan: OperationalReentryV04ProviderCompatibilityProbePlanV01,
): Omit<
  OperationalReentryV04ProviderCompatibilityProbePlanV01,
  "entries" | "integrity"
> & {
  ...
  const { entries, integrity, ...planWithoutEntriesOrIntegrity } = plan;
  return {
    ...structuredClone(planWithoutEntriesOrIntegrity),
    plan_fingerprint: integrity.fingerprint,
    entries: entries.map(({ invocation: _input, ...entry }) => ({
      ...structuredClone(entry),
...
export function validateOperationalReentryV04ProviderCompatibilityProbeExecutionResultV01(
  ...
  if (
    ...
    result.shapes.some(
      (shape, index) =>
        ...
        shape.shape !== ACGC_E2R2P6C_CANONICAL_SHAPE_ORDER_V01[index] ||
    ...
    failV01("operational_reentry_v04_probe_result_invalid");
  }
  ...
  for (const shape of result.shapes) {
    if (
      ...
      failV01("operational_reentry_v04_probe_stop_policy_invalid");
    }
    if (
  ...
  scanForbiddenMaterialV01({
    ...
    plan: projectOperationalReentryV04ProviderCompatibilityProbePlanForArtifactV01(
      result.plan,
    ),
...
function validatePreparedV01(
  value: OperationalReentryV04ProviderCompatibilityProbePreparedV01,
): void {
  [
    value.authorization,
    value.manifest,
  ...
  const nonTargetByShape = new Map(
    value.plan.entries.map((entry) => [
      entry.shape,
      fingerprintV01(
        entry.invocation.provider_material.continuation_context.filter(
  ...
  if (
    ...
    value.authorization.representative_shape_plan_fingerprint !==
      value.representative_shape_plan.integrity.fingerprint ||
    value.manifest.twin_b_zero_egress_witness_fingerprint !==
      value.representative_shape_plan.twin_b_identity_separation_witness.integrity
        .fingerprint ||
    value.authorization.twin_b_zero_egress_witness_fingerprint !==
      value.representative_shape_plan.twin_b_identity_separation_witness.integrity
        .fingerprint ||
    ...
    value.manifest.final_request_bytes !== 24576 ||
    ...
    value.manifest.request_family_kind !==
      "operational_reentry_v04_compatibility_probe" ||
    value.plan.request_family_kind !== "operational_reentry_v04_compatibility_probe" ||
    ...
    !dInput ||
    dInput.provider_material.continuation_context.length !== 0 ||
    fingerprintV01(dInput.provider_material.common_task_evidence) !==
      OPERATIONAL_REENTRY_MATCHED_COHORT_COMMON_TASK_EVIDENCE_FINGERPRINT_V02 ||
    ...
    value.plan.entries.some(
      (entry, index) =>
        entry.shape !== ACGC_E2R2P6C_CANONICAL_SHAPE_ORDER_V01[index] ||
        entry.canonical_order !== index ||
        entry.strict_schema_preflight !== "passed" ||
        entry.route_fingerprint !== ACGC_E2R2P6C_ROUTE_FINGERPRINT_V01 ||
        entry.provider_contract_fingerprint !==
          ACGC_E2R2P6C_PROVIDER_CONTRACT_FINGERPRINT_V01 ||
        entry.adapter_request_route_fingerprint !==
          ACGC_E2R2P6C_ADAPTER_REQUEST_ROUTE_FINGERPRINT_V01 ||
        entry.invocation.local_invocation_context.call_slot_id !==
          entry.call_slot_id ||
        entry.invocation.local_invocation_context.cohort_ref !==
          "acgc-e2r2p6c-v04-compatibility" ||
        entry.call_slot_id.startsWith("e2r2p-call-") ||
        entry.call_slot_id.startsWith("e2-call-") ||
        !entry.call_slot_id.startsWith("e2r2p6c-call-"),
    )
  ) {
    failV01("operational_reentry_v04_probe_prepared_identity_invalid");
  }
}

export function buildOperationalReentryV04ProviderCompatibilityProbeModelInvocationEnvelopeV01(
  entry: OperationalReentryV04ProviderCompatibilityProbePlanEntryV01,
...
function terminalFromErrorV01(
  ...
  try {
    ...
    if (
      ...
      failV01("operational_reentry_v04_probe_rejection_identity_mismatch");
    }
    if (
      ...
      failV01("operational_reentry_v04_probe_response_invalid_identity_mismatch");
    }
    if (
      invocationError?.provider_rejection_observation &&
      invocationError.provider_response_invalid_observation
    ) {
      failV01("operational_reentry_v04_probe_terminal_observation_ambiguous");
    }
    return terminalV01({
      entry,
      prepared,
      ...
      failure_code:
        ...
        OperationalReentryV04ProviderCompatibilityProbeErrorV01
          ? error.code
          : "operational_reentry_v04_probe_internal_failure"),
    ...
    return terminalV01({
      ...
      receipt: null,
      output: null,
      failure_code: "operational_reentry_v04_probe_internal_failure",
...
function terminalV01(input: {
  entry: OperationalReentryV04ProviderCompatibilityProbePlanEntryV01;
  prepared: OperationalReentryV04ProviderCompatibilityProbePreparedV01;
  category: OperationalReentryV04ProviderCompatibilityProbeTerminalCategoryV01;
  receipt: OperationalReentryV04ProviderCompatibilityProbeShapeTerminalV01["receipt"];
  output: OperationalReentryV04ProviderCompatibilityProbeShapeTerminalV01["normalized_output"];
  failure_code: string | null;
  provider_rejection_observation?: OperationalReentryV04ProviderCompatibilityProbeShapeTerminalV01["provider_rejection_observation"];
  provider_response_invalid_observation?: OperationalReentryV04ProviderCompatibilityProbeShapeTerminalV01["provider_response_invalid_observation"];
}): OperationalReentryV04ProviderCompatibilityProbeShapeTerminalV01 {
  if (
    ...
    failV01("operational_reentry_v04_probe_terminal_observation_mismatch");
  }
  ...
  if (
    ...
    failV01("operational_reentry_v04_probe_receipt_binding_invalid");
  }
  const exactCost =
  ...
  return sealV01("operational_reentry_v04_probe_shape_terminal_without_integrity_fingerprint", {
    ...
    local_invocation_identity_fingerprint:
      input.entry.local_invocation_identity_fingerprint,
...
function buildReportV01(
...
): OperationalReentryV04ProviderCompatibilityProbeReportV01 {
  ...
  const counts = Object.fromEntries(
    ACGC_E2R2P6C_TERMINAL_CATEGORIES_V01.map((category) => [
      category,
  ...
  return sealV01("operational_reentry_v04_probe_report_without_integrity_fingerprint", {
    report_version:
      OPERATIONAL_REENTRY_V04_PROVIDER_COMPATIBILITY_PROBE_REPORT_VERSION_V01,
    probe_id: probeId,
    outcome,
    ...
    limitations: [
      "accepted_all_shapes means only provider acceptance and local parser-closed v0.4 normalization for the four representative shapes.",
...
function readProviderBoundaryV01() {
  const representative =
    buildOperationalReentryV04ProviderCompatibilityProbeRepresentativeShapePlanV01()
      .entries[0];
  if (!representative) failV01("operational_reentry_v04_probe_shape_missing");
...
function assertExactRouteV01(
  ...
  if (
    ...
    route.provider_contract_fingerprint !==
      ACGC_E2R2P6C_PROVIDER_CONTRACT_FINGERPRINT_V01 ||
    route.provider_contract_fingerprint !==
      readOperationalReentryMatchedCohortProviderContractV04().integrity
        .fingerprint ||
    boundary.adapter_request_route_fingerprint !==
      ACGC_E2R2P6C_ADAPTER_REQUEST_ROUTE_FINGERPRINT_V01 ||
    route.integrity_fingerprint !==
      ACGC_E2R2P6C_ROUTE_FINGERPRINT_V01 ||
    ...
    failV01("operational_reentry_v04_probe_route_mismatch");
  }
}
...
function scanForbiddenMaterialV01(value: unknown): void {
  ...
  for (const forbidden of [
    ...
    if (text.includes(forbidden)) {
      failV01("operational_reentry_v04_probe_forbidden_material");
    }
  }
}
...
function authorizedOriginV01(
  value: string,
): OperationalReentryV04ProviderCompatibilityProbeAuthorizationExpectationsV01["authorized_origin"] {
  if (!AUTHORIZED_ORIGINS_V01.has(value)) {
    failV01("operational_reentry_v04_probe_repository_origin_mismatch");
  }
  return value as OperationalReentryV04ProviderCompatibilityProbeAuthorizationExpectationsV01["authorized_origin"];
}
...
function assertSealedV01(value: {
  ...
  if (
    ...
    failV01("operational_reentry_v04_probe_fingerprint_invalid");
  }
}
...
function timestampV01(value: unknown): number {
  if (typeof value !== "string") {
    failV01("operational_reentry_v04_probe_timestamp_invalid");
  }
...
function failV01(code: string): never {
  throw new OperationalReentryV04ProviderCompatibilityProbeErrorV01(
    code,
  );
}
