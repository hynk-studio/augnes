...
const selectedRuntimeAuditDefaultForbiddenCapabilities = [
  ...
  "No new API route.",
  "No broad all-route instrumentation.",
  "No DB migrations.",
  "No global DB config.",
  "No DB writes except caller-injected local test DB writes for this audit event store.",
  "No direct DB reads except caller-injected local test DB reads for this audit event store.",
  "No local file write.",
  "No local file read.",
  "No import apply.",
