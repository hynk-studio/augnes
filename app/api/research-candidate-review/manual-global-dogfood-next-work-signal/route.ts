...
const routeVersion =
  "research_candidate_manual_global_dogfood_next_work_signal_route.v0.1" as const;
...
export async function POST(request: Request) {
  ...
  const result = writeResearchCandidateManualGlobalDogfoodNextWorkSignal(body);
  return NextResponse.json(
    {
      ok: result.ok,
      route_version: routeVersion,
      ...
      next_work_signal_record: result.next_work_signal_record,
