...
const routeVersion =
  "research_candidate_manual_global_dogfood_next_work_bias_route.v0.1" as const;
...
export async function POST(request: Request) {
  ...
  const result = writeResearchCandidateManualGlobalDogfoodNextWorkBias(body);
  return NextResponse.json(
    {
      ok: result.ok,
      route_version: routeVersion,
      ...
      next_work_bias_record: result.next_work_bias_record,
