...
const routeVersion =
  "research_candidate_manual_global_dogfood_perspective_apply_rollback_route.v0.1" as const;
...
export async function POST(
  ...
  const result = rollbackResearchCandidateManualGlobalDogfoodPerspectiveApplyReceipt({
