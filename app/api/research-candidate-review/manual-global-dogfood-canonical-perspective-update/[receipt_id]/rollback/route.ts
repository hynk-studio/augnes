...
const routeVersion =
  "research_candidate_manual_global_dogfood_canonical_perspective_update_rollback_route.v0.1" as const;
...
export async function POST(
  ...
  const result = rollbackResearchCandidateManualGlobalDogfoodCanonicalPerspectiveUpdateReceipt({
