...
} from "@/lib/research-candidate-review/manual-global-dogfood-perspective-state-application-write";
...
const routeVersion =
  "research_candidate_manual_global_dogfood_perspective_state_application_rollback_route.v0.1" as const;
...
export async function POST(
  ...
  const result = rollbackResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationReceipt({
