...
const routeVersion =
  "research_candidate_manual_global_dogfood_perspective_writer_compatibility_route.v0.1" as const;
...
export async function POST(request: Request) {
  ...
  const result = writeResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibility(body);
  return NextResponse.json(
    {
      ok: result.ok,
      route_version: routeVersion,
      ...
      perspective_writer_compatibility_record: result.perspective_writer_compatibility_record,
