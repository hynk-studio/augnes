...
const routeVersion =
  "research_candidate_manual_global_dogfood_perspective_relay_route.v0.1" as const;
...
export async function POST(request: Request) {
  ...
  const result = writeResearchCandidateManualGlobalDogfoodPerspectiveRelay(body);
  return NextResponse.json(
    {
      ok: result.ok,
      route_version: routeVersion,
      ...
      perspective_relay_record: result.perspective_relay_record,
