...
export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_WRITER_COMPATIBILITY_CONTRACT_KIND =
  "research_candidate_manual_global_dogfood_perspective_writer_compatibility_contract" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_WRITER_COMPATIBILITY_CONTRACT_VERSION =
  "research_candidate_manual_global_dogfood_perspective_writer_compatibility_contract.v0.1" as const;

export type ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityAuthorizationMode =
  | "preview_only"
...
export type ResearchCandidateManualGlobalDogfoodPerspectiveWriterTarget =
...
export type ResearchCandidateManualGlobalDogfoodPerspectiveWriterDefaultTarget =
  | "manual_specific_existing_canonical_state_writer_adapter"
  | "manual_specific_current_working_writer_adapter"
  | "blocked";

export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityContractInput {
  readback: unknown;
  operator_intent_label?: string;
  requested_future_write_mode?: string;
  intended_future_writer_target?: ResearchCandidateManualGlobalDogfoodPerspectiveWriterTarget;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityMapping {
  ...
  warnings: string[];
  intended_future_writer_target: ResearchCandidateManualGlobalDogfoodPerspectiveWriterTarget;
  default_future_writer_target: ResearchCandidateManualGlobalDogfoodPerspectiveWriterDefaultTarget;
  can_feed_future_writer_compatibility_write_candidate: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityCandidate {
  candidate_kind: "manual_global_dogfood_perspective_writer_compatibility_candidate";
  candidate_status:
    | "ready_for_future_perspective_writer_compatibility_write_authorization"
    | "blocked_before_perspective_writer_compatibility_authorization";
  writer_compatibility_scope_hint:
    ...
    | "manual_specific_current_working_writer_adapter"
    | "blocked";
  writer_compatibility_strength_hint: "low" | "medium" | "high" | "blocked";
  reason: string;
  writes_now: false;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveExistingCurrentWorkingWriterCompatibility {
  ...
  recommended_future_mapping_path:
    ...
    | "existing_current_working_writer_after_mapping"
    | "blocked";
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveExistingCanonicalStateWriterCompatibility {
  ...
  recommended_future_mapping_path:
    ...
    | "existing_canonical_state_writer_after_mapping"
    | "blocked";
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveManualWriterCompatibilityPath {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityIdempotencyPreview {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityFinding {
  finding_code: string;
  severity: "ready" | "warning" | "blocker";
  applies_to:
    | "manual_global_dogfood_perspective_state_application"
    | "future_perspective_writer_compatibility"
    | "existing_current_working_perspective_writer"
    | "existing_canonical_perspective_state_writer"
    | "manual_specific_perspective_writer_compatibility_path";
  summary: string;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityNonWriteConfirmation {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityValidation {
  passed: boolean;
  contract_fingerprint: string;
  fingerprint_algorithm: "fnv1a32_canonical_json_v0_1";
  active_committed_perspective_state_application_receipt_present: boolean;
  active_committed_perspective_state_application_record_present: boolean;
  source_fingerprints_present: boolean;
  state_application_label_present: boolean;
  state_application_rationale_present: boolean;
  state_application_storage_path_is_manual_specific: boolean;
  state_application_expected_future_write_scope_is_record_only: boolean;
  state_application_target_remains_manual_specific: boolean;
  ...
  existing_current_working_writer_compatible: boolean;
  existing_canonical_state_writer_compatible: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityAuthorityBoundary {
  preview_only: true;
  read_only: true;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityContract {
  contract_kind: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_WRITER_COMPATIBILITY_CONTRACT_KIND;
  contract_version: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_WRITER_COMPATIBILITY_CONTRACT_VERSION;
  scope: ResearchCandidateReviewScope;
  operator_intent_label: string;
  requested_future_write_mode: string;
  source_perspective_state_application_readback_ref: string;
  ...
  operator_authorization_mode: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityAuthorizationMode;
  proposed_writer_compatibility_mapping: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityMapping;
  proposed_writer_compatibility_candidate: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityCandidate;
  existing_current_working_writer_compatibility: ResearchCandidateManualGlobalDogfoodPerspectiveExistingCurrentWorkingWriterCompatibility;
  existing_canonical_state_writer_compatibility: ResearchCandidateManualGlobalDogfoodPerspectiveExistingCanonicalStateWriterCompatibility;
  proposed_manual_writer_compatibility_path: ResearchCandidateManualGlobalDogfoodPerspectiveManualWriterCompatibilityPath;
  idempotency_contract_preview: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityIdempotencyPreview;
  compatibility_findings: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityFinding[];
  blocker_reasons: string[];
  warning_reasons: string[];
  required_future_authorization: string[];
  required_future_checks: string[];
  non_write_confirmation: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityNonWriteConfirmation;
  validation: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityValidation;
  authority_boundary: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityAuthorityBoundary;
