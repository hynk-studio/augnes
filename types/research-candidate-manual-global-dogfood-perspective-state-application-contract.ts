...
export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_STATE_APPLICATION_CONTRACT_KIND =
  "research_candidate_manual_global_dogfood_perspective_state_application_contract" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_STATE_APPLICATION_CONTRACT_VERSION =
  "research_candidate_manual_global_dogfood_perspective_state_application_contract.v0.1" as const;

export type ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationAuthorizationMode =
  | "preview_only"
...
export type ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationTarget =
...
export type ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationDefaultTarget =
  | "manual_specific_existing_canonical_state_application_adapter"
  | "manual_specific_current_working_application_adapter"
  | "blocked";

export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationContractInput {
  readback: unknown;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationMapping {
  ...
  warnings: string[];
  intended_future_state_application_target: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationTarget;
  default_future_state_application_target: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationDefaultTarget;
  can_feed_future_state_application_write_candidate: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationCandidate {
  candidate_kind: "manual_global_dogfood_perspective_state_application_candidate";
  candidate_status:
    | "ready_for_future_perspective_state_application_write_authorization"
    | "blocked_before_perspective_state_application_authorization";
  state_application_scope_hint:
    ...
    | "manual_specific_current_working_application_adapter"
    | "blocked";
  state_application_strength_hint: "low" | "medium" | "high" | "blocked";
  reason: string;
  writes_now: false;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveExistingCurrentWorkingApplicationCompatibility {
  ...
  recommended_future_mapping_path:
    ...
    | "existing_current_working_application_after_mapping"
    | "blocked";
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveExistingCanonicalStateApplicationCompatibility {
  ...
  recommended_future_mapping_path:
    ...
    | "existing_canonical_state_application_after_mapping"
    | "blocked";
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveManualStateApplicationWritePath {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationIdempotencyPreview {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationCompatibilityFinding {
  finding_code: string;
  severity: "ready" | "warning" | "blocker";
  applies_to:
    | "manual_global_dogfood_perspective_adapter"
    | "future_perspective_state_application"
    | "existing_current_working_perspective_application"
    | "existing_canonical_perspective_state_application"
    | "manual_specific_perspective_state_application_write_path";
  summary: string;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationNonWriteConfirmation {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationValidation {
  passed: boolean;
  contract_fingerprint: string;
  fingerprint_algorithm: "fnv1a32_canonical_json_v0_1";
  active_committed_perspective_adapter_receipt_present: boolean;
  active_committed_perspective_adapter_record_present: boolean;
  source_fingerprints_present: boolean;
  adapter_label_present: boolean;
  adapter_rationale_present: boolean;
  adapter_storage_path_is_manual_specific: boolean;
  adapter_expected_future_write_scope_is_record_only: boolean;
  adapter_target_remains_manual_specific: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationAuthorityBoundary {
  preview_only: true;
  read_only: true;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationContract {
  contract_kind: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_STATE_APPLICATION_CONTRACT_KIND;
  contract_version: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_STATE_APPLICATION_CONTRACT_VERSION;
  scope: ResearchCandidateReviewScope;
  operator_intent_label: string;
  requested_future_write_mode: string;
  source_perspective_adapter_readback_ref: string;
  ...
  operator_authorization_mode: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationAuthorizationMode;
  proposed_state_application_mapping: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationMapping;
  proposed_state_application_candidate: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationCandidate;
  proposed_existing_current_working_application_compatibility: ResearchCandidateManualGlobalDogfoodPerspectiveExistingCurrentWorkingApplicationCompatibility;
  proposed_existing_canonical_state_application_compatibility: ResearchCandidateManualGlobalDogfoodPerspectiveExistingCanonicalStateApplicationCompatibility;
  proposed_manual_state_application_write_path: ResearchCandidateManualGlobalDogfoodPerspectiveManualStateApplicationWritePath;
  idempotency_contract_preview: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationIdempotencyPreview;
  compatibility_findings: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationCompatibilityFinding[];
  blocker_reasons: string[];
  warning_reasons: string[];
  required_future_authorization: string[];
  required_future_checks: string[];
  non_write_confirmation: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationNonWriteConfirmation;
  validation: ResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationValidation;
