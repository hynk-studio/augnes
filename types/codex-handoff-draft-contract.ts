// Contract-only Codex Handoff Draft v0.1 shape.
// This file defines types only. It does not implement handoff draft runtime
// build, draft writes, Codex execution, GitHub automation, branch/commit/PR
// creation, external handoff sending, agent routing/execution, provider/OpenAI
// calls, retrieval/RAG execution, source fetching, crawling, DB access, durable
// memory writes, Perspective promotion, proof/evidence writes, Formation
// Receipt writes, work mutation, routes, UI, schema changes, migrations, or
// product writes.

export type CodexHandoffDraftContractKind = "codex_handoff_draft_contract";

export type CodexHandoffDraftContractVersion =
  "codex_handoff_draft_contract.v0.1";

export type CodexHandoffDraftInputField =
  | "handoff_scope_ref"
...
export type CodexHandoffDraftOutputField =
  | "draft_id"
  | "draft_version"
  | "target_repository"
  | "canonical_checkout"
...
export type CodexHandoffDraftSectionKind =
  | "target_repository"
  | "canonical_checkout"
  | "branch_name_hint"
  | "pr_title_hint"
...
export interface CodexHandoffDraftContractScope {
...
export interface CodexHandoffDraftPrinciples {
...
export interface CodexHandoffDraftSectionFamily {
  section_kind: CodexHandoffDraftSectionKind;
...
export interface CodexHandoffDraftForbiddenActionsPolicy {
...
export interface CodexHandoffDraftAuthorityBoundary {
...
export interface CodexHandoffDraftValidationPolicy
  extends CodexHandoffDraftPrinciples {
...
export interface CodexHandoffDraftPrivacyPolicy {
...
export interface CodexHandoffDraftContractFixture {
  contract_kind: CodexHandoffDraftContractKind;
  contract_version: CodexHandoffDraftContractVersion;
  source_ai_context_packet_validation_ref: string;
  source_ai_context_packet_validation_fingerprint: string;
  contract_scope: CodexHandoffDraftContractScope;
  draft_principles: CodexHandoffDraftPrinciples;
  handoff_input_fields: CodexHandoffDraftInputField[];
  handoff_output_fields: CodexHandoffDraftOutputField[];
  draft_section_families: CodexHandoffDraftSectionFamily[];
  forbidden_actions_policy: CodexHandoffDraftForbiddenActionsPolicy;
  sample_codex_handoff_draft_preview: unknown;
  authority_boundary: CodexHandoffDraftAuthorityBoundary;
  validation_policy: CodexHandoffDraftValidationPolicy;
  privacy_policy: CodexHandoffDraftPrivacyPolicy;
  recommendation_status: "ready_for_codex_handoff_draft_implementation_v0_1";
  next_recommended_slice: "codex_handoff_draft_implementation_v0_1";
}
