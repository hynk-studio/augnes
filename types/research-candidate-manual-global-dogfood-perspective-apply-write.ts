...
export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_APPLY_WRITE_CONFIRMATION =
  "I authorize writing this manual global dogfood Perspective apply candidate to a Perspective apply record" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_APPLY_ROLLBACK_CONFIRMATION =
  "I authorize rolling back this manual global dogfood Perspective apply receipt" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_APPLY_WRITE_KIND =
  "research_candidate_manual_global_dogfood_perspective_apply_write" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_APPLY_WRITE_VERSION =
  "research_candidate_manual_global_dogfood_perspective_apply_write.v0.1" as const;

export type ResearchCandidateManualGlobalDogfoodPerspectiveApplyAuthorizationKind =
  "manual_operator_authorized_perspective_apply_write";

export type ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteMode =
  | "commit"
  | "replay_if_duplicate"
  | "supersede_previous";

export type ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteStatus =
  | "committed"
  | "duplicate_replayed"
  | "superseded"
  | "rolled_back";

export type ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteResultStatus =
  | "committed"
  | "duplicate_replayed"
  | "superseded"
  | "rolled_back"
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyOperatorAuthorization {
  authorization_kind: ResearchCandidateManualGlobalDogfoodPerspectiveApplyAuthorizationKind;
  operator_confirmation_text: string;
  write_mode: ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteMode;
  supersedes_receipt_id?: string | null;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteRequest {
  perspective_apply_contract: ResearchCandidateManualGlobalDogfoodPerspectiveApplyContract;
  perspective_apply_review: ResearchCandidateManualGlobalDogfoodPerspectiveApplyReview;
  source_canonical_perspective_update_readback?: ResearchCandidateManualGlobalDogfoodCanonicalPerspectiveUpdateReadback | null;
  operator_authorization: ResearchCandidateManualGlobalDogfoodPerspectiveApplyOperatorAuthorization;
  requested_side_effects?: Record<string, unknown>;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyRollbackAuthorization {
  authorization_kind: "manual_operator_authorized_perspective_apply_rollback";
  operator_confirmation_text: string;
  rollback_reason: string;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyRollbackRequest {
  receipt_id: string;
  rollback_authorization: ResearchCandidateManualGlobalDogfoodPerspectiveApplyRollbackAuthorization;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteAuthorityBoundary {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteValidation {
  passed: boolean;
  failure_codes: string[];
  idempotency_key: string | null;
  exact_operator_confirmation_present: boolean;
  ready_perspective_apply_contract_present: boolean;
  accepted_perspective_apply_review_present: boolean;
  ...
  source_canonical_perspective_update_receipt_active_committed: boolean;
  source_canonical_perspective_update_record_matches_contract: boolean;
  ...
  proposed_perspective_apply_candidate_ready: boolean;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteReceipt {
  receipt_id: string;
  created_at: string;
  scope: ResearchCandidateReviewScope;
  source_perspective_apply_contract_fingerprint: string;
  source_perspective_apply_review_fingerprint: string;
  ...
  write_status: Exclude<
    ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteStatus,
    "duplicate_replayed"
  >;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyRecord {
  perspective_apply_record_id: string;
  receipt_id: string;
  created_at: string;
  scope: ResearchCandidateReviewScope;
  source_canonical_perspective_update_receipt_id: string;
  ...
  existing_apply_path_compatibility: Record<string, unknown>;
  source_refs: string[];
  authority_profile: string;
  perspective_apply_record_fingerprint: string;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyRollbackRecord {
  rollback_id: string;
  created_at: string;
  receipt_id: string;
  rollback_reason: string;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyRecordsByReceipt {
  receipt: ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteReceipt;
  perspective_apply_record: ResearchCandidateManualGlobalDogfoodPerspectiveApplyRecord | null;
  rollback: ResearchCandidateManualGlobalDogfoodPerspectiveApplyRollbackRecord | null;
  superseded: boolean;
  rolled_back: boolean;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyReadback {
  readback_kind: "research_candidate_manual_global_dogfood_perspective_apply_readback";
  readback_version: "research_candidate_manual_global_dogfood_perspective_apply_readback.v0.1";
  scope: ResearchCandidateReviewScope;
  storage_path: "manual_specific_perspective_apply_tables";
  records_by_receipt: ResearchCandidateManualGlobalDogfoodPerspectiveApplyRecordsByReceipt[];
  latest_receipts: ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteReceipt[];
  latest_active_committed: ResearchCandidateManualGlobalDogfoodPerspectiveApplyRecordsByReceipt | null;
  count: number;
  authority_boundary: ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteAuthorityBoundary;
  raw_manual_note_text_present: false;
  raw_result_report_text_present: false;
  operator_notes_persisted: false;
  perspective_apply_record_written: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteResult {
  ok: boolean;
  result_status: ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteResultStatus;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyRollbackResult {
  ok: boolean;
  result_status: ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteResultStatus;
  rollback: ResearchCandidateManualGlobalDogfoodPerspectiveApplyRollbackRecord | null;
  receipt: ResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteReceipt | null;
