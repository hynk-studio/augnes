...
export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_APPLY_CONTRACT_KIND =
  "research_candidate_manual_global_dogfood_perspective_apply_contract" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_APPLY_CONTRACT_VERSION =
  "research_candidate_manual_global_dogfood_perspective_apply_contract.v0.1" as const;

export type ResearchCandidateManualGlobalDogfoodPerspectiveApplyAuthorizationMode =
  | "preview_only"
  | "ready_for_future_perspective_apply_write_authorization"
  | "blocked_before_perspective_apply_authorization";

export type ResearchCandidateManualGlobalDogfoodPerspectiveApplyTarget =
  | "canonical_perspective_state"
  | "current_working_perspective"
  | "blocked";

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyContractInput {
  readback: unknown;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyMapping {
  ...
  warnings: string[];
  intended_future_apply_target: ResearchCandidateManualGlobalDogfoodPerspectiveApplyTarget;
  can_feed_future_perspective_apply_write_candidate: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyCandidate {
  ...
  apply_scope_hint:
    ...
    | "current_working_perspective"
    | "blocked";
  apply_strength_hint: "low" | "medium" | "high" | "blocked";
  reason: string;
  writes_now: false;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyExistingCompatibility {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyIdempotencyPreview {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyCompatibilityFinding {
  finding_code: string;
  severity: "ready" | "warning" | "blocker";
  applies_to:
    | "manual_global_dogfood_canonical_perspective_update"
    | "future_perspective_apply"
    | "existing_current_working_perspective_apply_path";
  summary: string;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyNonWriteConfirmation {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyValidation {
  passed: boolean;
  contract_fingerprint: string;
  fingerprint_algorithm: "fnv1a32_canonical_json_v0_1";
  active_committed_canonical_perspective_update_receipt_present: boolean;
  active_committed_canonical_perspective_update_record_present: boolean;
  ...
  source_readback_preserves_no_apply_state_promotion_memory_work_proof_metric_writes: boolean;
  no_write_authority: boolean;
  blocker_count: number;
  warning_count: number;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyAuthorityBoundary {
  preview_only: true;
  read_only: true;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveApplyContract {
  contract_kind: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_APPLY_CONTRACT_KIND;
  contract_version: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_APPLY_CONTRACT_VERSION;
  scope: ResearchCandidateReviewScope;
  operator_intent_label: string;
  requested_future_write_mode: string;
  source_canonical_perspective_update_readback_ref: string;
  ...
  operator_authorization_mode: ResearchCandidateManualGlobalDogfoodPerspectiveApplyAuthorizationMode;
  proposed_perspective_apply_mapping: ResearchCandidateManualGlobalDogfoodPerspectiveApplyMapping;
  proposed_apply_candidate: ResearchCandidateManualGlobalDogfoodPerspectiveApplyCandidate;
  proposed_existing_apply_path_compatibility: ResearchCandidateManualGlobalDogfoodPerspectiveApplyExistingCompatibility;
  idempotency_contract_preview: ResearchCandidateManualGlobalDogfoodPerspectiveApplyIdempotencyPreview;
  compatibility_findings: ResearchCandidateManualGlobalDogfoodPerspectiveApplyCompatibilityFinding[];
  blocker_reasons: string[];
  warning_reasons: string[];
  required_future_authorization: string[];
  required_future_checks: string[];
  non_write_confirmation: ResearchCandidateManualGlobalDogfoodPerspectiveApplyNonWriteConfirmation;
  validation: ResearchCandidateManualGlobalDogfoodPerspectiveApplyValidation;
