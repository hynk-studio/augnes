...
export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_STATE_MUTATION_REVIEW_KIND =
  "research_candidate_manual_global_dogfood_perspective_state_mutation_review" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_STATE_MUTATION_REVIEW_VERSION =
  "research_candidate_manual_global_dogfood_perspective_state_mutation_review.v0.1" as const;

export type ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReviewDecision =
...
export type ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReviewStatus =
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReviewInput {
  perspective_state_mutation_contract: ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationContract;
  operator_decision: ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReviewDecision;
  operator_note?: string;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationAcceptedMappingSummary {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReviewValidation {
  passed: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReview {
  review_kind: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_STATE_MUTATION_REVIEW_KIND;
  review_version: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_STATE_MUTATION_REVIEW_VERSION;
  scope: ResearchCandidateReviewScope;
  source_contract_ref: string;
  source_contract_fingerprint: string;
  operator_decision: ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReviewDecision;
  review_status: ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReviewStatus;
  accepted_mapping_summary: ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationAcceptedMappingSummary | null;
  unresolved_blockers: string[];
  warning_reasons: string[];
  future_write_requirements: string[];
  validation: ResearchCandidateManualGlobalDogfoodPerspectiveStateMutationReviewValidation;
