...
export const PROJECT_VERIFY_PORTABLE_EXPORT_CLASSIFICATION_V01 = {
  ...
  canonical_lifecycle_material: [
    ...
    "project_verify_lifecycle_proposal.v0.1 profiles and exact selected-record/family-head expectations",
    "ReviewDecisionV01, semantic commit gate, StateTransitionReceiptV01, persisted semantic state lifecycle binding, and semantic target-head lineage",
    "later TaskContextPacket and ContextUseReview records that preserve exact Transition lineage",
  ],
  rebuildable_material: [
    ...
    "relation counts",
    "display summaries",
    "lifecycle status and current Claim/relation read projections",
    "applicability overlap grouping and relation buckets",
    "project_verify_reconciliation.v0.1 and project_verify_lineage.v0.1 response objects",
  ],
  import_authority: {
