import type { HandoffContextUpdateContractOperatorDecisionPreview } from "./handoff-context-update-contract-decision";
import type {
  HandoffContextUpdateContractEntry,
  HandoffContextUpdateContractMaterial,
} from "./handoff-context-update-contract-preview";

export const HANDOFF_CONTEXT_UPDATE_CONTRACT_RECORD_VERSION =
  "handoff_context_update_contract_record.v0.1" as const;
export const HANDOFF_CONTEXT_UPDATE_CONTRACT_RECEIPT_VERSION =
  "handoff_context_update_contract_receipt.v0.1" as const;
export const HANDOFF_CONTEXT_UPDATE_CONTRACT_STORE_VERSION =
  "handoff_context_update_contract_store.v0.1" as const;
export const HANDOFF_CONTEXT_UPDATE_CONTRACT_WRITE_SCOPE =
  "project:augnes" as const;

export interface HandoffContextUpdateContractWriteInput {
  operator_decision_preview: HandoffContextUpdateContractOperatorDecisionPreview;
  operator_approval: HandoffContextUpdateContractOperatorApproval;
  idempotency_key: string;
  requested_side_effects?: Record<string, unknown>;
  notes?: string[];
}

export interface HandoffContextUpdateContractOperatorApproval {
...
export interface HandoffContextUpdateContractAuthorityProfile {
...
export interface HandoffContextUpdateContractNoHandoffApply {
...
export interface HandoffContextUpdateContractWriteValidation {
...
export interface HandoffContextUpdateContractWriteAuthorityBoundary {
  durable_local_handoff_context_update_contract: true;
  source_of_truth: false;
  local_project_handoff_context_update_contract_only: true;
  can_write_db: boolean;
  can_create_handoff_context_update_contract_record: boolean;
  can_create_handoff_context_update_contract_receipt: boolean;
...
export interface HandoffContextUpdateContractNoSideEffects
  extends HandoffContextUpdateContractNoHandoffApply {
  handoff_context_update_contract_record_written: boolean;
  handoff_context_update_contract_receipt_written: boolean;
  handoff_context_update_contract_persisted: boolean;
  handoff_context_update_contract_written: boolean;
}

export interface HandoffContextUpdateContractRecord {
  record_version: typeof HANDOFF_CONTEXT_UPDATE_CONTRACT_RECORD_VERSION;
  record_id: string;
  idempotency_key: string;
  created_at: string;
  scope: typeof HANDOFF_CONTEXT_UPDATE_CONTRACT_WRITE_SCOPE;
  operator_ref: string;
  source_refs: string[];
  ...
  proposed_handoff_context_update_contract: HandoffContextUpdateContractMaterial;
  proposed_handoff_context_entries: HandoffContextUpdateContractEntry[];
  proposed_handoff_context_entry_count: number;
  proposed_handoff_section_counts: Record<string, number>;
  authority_profile: HandoffContextUpdateContractAuthorityProfile;
  review_status: "recorded_as_scoped_handoff_context_update_contract";
  persistence_horizon: "local_project_handoff_context_update_contract_store";
  no_handoff_apply_performed: HandoffContextUpdateContractNoHandoffApply;
  write_validation: HandoffContextUpdateContractWriteValidation;
  authority_boundary: HandoffContextUpdateContractWriteAuthorityBoundary;
  notes: string[];
  record_fingerprint: string;
}

export interface HandoffContextUpdateContractReceipt {
  receipt_version: typeof HANDOFF_CONTEXT_UPDATE_CONTRACT_RECEIPT_VERSION;
  ...
  source_refs: string[];
  no_side_effects: HandoffContextUpdateContractNoSideEffects;
}

export type HandoffContextUpdateContractWriteStatus =
  | "written"
  | "idempotent_existing"
  | "read"
  | "listed"
...
export interface HandoffContextUpdateContractStoreResult {
  store_version: typeof HANDOFF_CONTEXT_UPDATE_CONTRACT_STORE_VERSION;
  scope: typeof HANDOFF_CONTEXT_UPDATE_CONTRACT_WRITE_SCOPE;
  ...
  error_code: HandoffContextUpdateContractWriteStatus | null;
  no_side_effects: HandoffContextUpdateContractNoSideEffects;
}
