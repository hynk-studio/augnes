...
export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_EXISTING_WRITER_DRY_RUN_REVIEW_KIND =
  "research_candidate_manual_global_dogfood_perspective_existing_writer_dry_run_review" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_EXISTING_WRITER_DRY_RUN_REVIEW_VERSION =
  "research_candidate_manual_global_dogfood_perspective_existing_writer_dry_run_review.v0.1" as const;

export type ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReviewDecision =
...
export type ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReviewStatus =
  | "ready_for_future_existing_writer_dry_run_adapter_write_slice"
  | "blocked_existing_writer_dry_run_contract_not_ready"
  | "blocked_existing_writer_dry_run_adapter_mapping_revision_required"
  | "rejected_by_operator"
  | "deferred_by_operator";

export interface ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReviewInput {
  existing_writer_dry_run_contract: ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunContract;
  operator_decision: ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReviewDecision;
  operator_note?: string;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunAcceptedMappingSummary {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReviewValidation {
  passed: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReview {
  review_kind: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_EXISTING_WRITER_DRY_RUN_REVIEW_KIND;
  review_version: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_EXISTING_WRITER_DRY_RUN_REVIEW_VERSION;
  scope: ResearchCandidateReviewScope;
  source_contract_ref: string;
  source_contract_fingerprint: string;
  operator_decision: ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReviewDecision;
  review_status: ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReviewStatus;
  accepted_mapping_summary: ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunAcceptedMappingSummary | null;
  unresolved_blockers: string[];
  warning_reasons: string[];
  future_write_requirements: string[];
  validation: ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunReviewValidation;
  authority_boundary: ResearchCandidateManualGlobalDogfoodPerspectiveExistingWriterDryRunContract["authority_boundary"];
}
