...
export const HANDOFF_PACKET_COPY_EXPORT_CONTRACT_DECISION_PREVIEW_VERSION =
  "handoff_packet_copy_export_contract_operator_decision_preview.v0.1" as const;

export type HandoffPacketCopyExportContractDecisionPreviewStatus =
  | "insufficient_data"
  | "blocked"
...
export type HandoffPacketCopyExportContractOperatorDecisionIntent =
  | "approve_for_handoff_packet_copy_export_contract_record"
  | "keep_preview_only"
  | "reject";

export interface HandoffPacketCopyExportContractDecisionPreviewInput {
  handoff_packet_copy_export_contract_preview?: unknown;
  requested_operator_ref?: string;
  requested_idempotency_key?: string;
  review_confirmation_ref?: string;
  operator_decision_intent?:
    | HandoffPacketCopyExportContractOperatorDecisionIntent
    | string;
  scope?: string;
  as_of?: string;
  source_refs?: string[];
...
export interface HandoffPacketCopyExportContractDecisionReadiness {
  write_ready: boolean;
...
export interface HandoffPacketCopyExportContractDecisionAuthorityBoundary {
  read_only: true;
  advisory_only: true;
...
export interface HandoffPacketCopyExportContractOperatorDecisionPreview {
  preview_version: typeof HANDOFF_PACKET_COPY_EXPORT_CONTRACT_DECISION_PREVIEW_VERSION;
  scope: string;
  as_of: string;
  source_refs: string[];
  decision_preview_status: HandoffPacketCopyExportContractDecisionPreviewStatus;
  recommended_operator_decision:
    | "approve_for_handoff_packet_copy_export_contract_record"
    | "keep_preview_only"
    | "reject";
  available_operator_decisions: HandoffPacketCopyExportContractOperatorDecisionIntent[];
  input_summary: {
  ...
  write_readiness: HandoffPacketCopyExportContractDecisionReadiness;
  ...
  would_write_handoff_packet_copy_export_contract_decision_preview: {
    ...
    source_refs: string[];
    evidence_refs: string[];
    contract_preview: HandoffPacketCopyExportContractPreview | null;
  };
  operator_review_checklist: string[];
  would_not_write: string[];
  non_goals: string[];
  authority_boundary: HandoffPacketCopyExportContractDecisionAuthorityBoundary;
}
