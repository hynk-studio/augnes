...
} from "./perspective-unit-scoped-write-preview";

export const PERSPECTIVE_UNIT_RECORD_VERSION =
  "perspective_unit_record.v0.1" as const;
export const PERSPECTIVE_UNIT_RECEIPT_VERSION =
  "perspective_unit_receipt.v0.1" as const;
export const PERSPECTIVE_UNIT_STORE_VERSION =
  "perspective_unit_store.v0.1" as const;
export const PERSPECTIVE_UNIT_SCOPE = "project:augnes" as const;

export interface PerspectiveUnitWriteInput {
  scoped_write_preview: PerspectiveUnitScopedWritePreview;
  operator_approval: PerspectiveUnitOperatorApproval;
  idempotency_key: string;
  requested_side_effects?: Record<string, unknown>;
  notes?: string[];
}

export interface PerspectiveUnitOperatorApproval {
...
export interface PerspectiveUnitRecordAuthorityProfile {
...
export interface PerspectiveUnitNoPromotionPerformed {
...
export interface PerspectiveUnitWriteValidation {
...
export interface PerspectiveUnitWriteAuthorityBoundary {
  durable_local_perspective_unit: true;
  source_of_truth: false;
  local_project_perspective_unit_only: true;
  can_write_db: boolean;
  can_create_perspective_unit_record: boolean;
  can_create_perspective_unit_receipt: boolean;
...
export interface PerspectiveUnitNoSideEffects {
  perspective_unit_record_written: boolean;
  perspective_unit_receipt_written: boolean;
  perspective_unit_persisted: boolean;
...
export interface PerspectiveUnitRecord {
  record_version: typeof PERSPECTIVE_UNIT_RECORD_VERSION;
  record_id: string;
  idempotency_key: string;
  created_at: string;
  scope: typeof PERSPECTIVE_UNIT_SCOPE;
  operator_ref: string;
  source_refs: string[];
  ...
  authority_profile: PerspectiveUnitRecordAuthorityProfile;
  review_status: "recorded_as_scoped_perspective_unit";
  persistence_horizon: "local_project_perspective_unit_record";
  no_promotion_performed: PerspectiveUnitNoPromotionPerformed;
  write_validation: PerspectiveUnitWriteValidation;
  authority_boundary: PerspectiveUnitWriteAuthorityBoundary;
  notes: string[];
  record_fingerprint: string;
}

export interface PerspectiveUnitReceipt {
  receipt_version: typeof PERSPECTIVE_UNIT_RECEIPT_VERSION;
  ...
  source_refs: string[];
  no_side_effects: PerspectiveUnitNoSideEffects;
}

export type PerspectiveUnitWriteStatus =
  | "written"
  | "idempotent_existing"
  | "read"
  | "listed"
...
export interface PerspectiveUnitStoreResult {
  store_version: typeof PERSPECTIVE_UNIT_STORE_VERSION;
  scope: typeof PERSPECTIVE_UNIT_SCOPE;
  ...
  error_code: PerspectiveUnitWriteStatus | null;
  no_side_effects: PerspectiveUnitNoSideEffects;
}
