...
export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_WRITER_COMPATIBILITY_REVIEW_KIND =
  "research_candidate_manual_global_dogfood_perspective_writer_compatibility_review" as const;

export const RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_WRITER_COMPATIBILITY_REVIEW_VERSION =
  "research_candidate_manual_global_dogfood_perspective_writer_compatibility_review.v0.1" as const;

export type ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReviewDecision =
...
export type ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReviewStatus =
  | "ready_for_future_perspective_writer_compatibility_write_slice"
  | "blocked_perspective_writer_compatibility_contract_not_ready"
  | "blocked_perspective_writer_compatibility_mapping_revision_required"
  | "rejected_by_operator"
  | "deferred_by_operator";

export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReviewInput {
  perspective_writer_compatibility_contract: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityContract;
  operator_decision: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReviewDecision;
  operator_note?: string;
}

export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityAcceptedMappingSummary {
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReviewValidation {
  passed: boolean;
...
export interface ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReview {
  review_kind: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_WRITER_COMPATIBILITY_REVIEW_KIND;
  review_version: typeof RESEARCH_CANDIDATE_MANUAL_GLOBAL_DOGFOOD_PERSPECTIVE_WRITER_COMPATIBILITY_REVIEW_VERSION;
  scope: ResearchCandidateReviewScope;
  source_contract_ref: string;
  source_contract_fingerprint: string;
  operator_decision: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReviewDecision;
  review_status: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReviewStatus;
  accepted_mapping_summary: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityAcceptedMappingSummary | null;
  unresolved_blockers: string[];
  warning_reasons: string[];
  future_write_requirements: string[];
  validation: ResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityReviewValidation;
