...
const reminder = [
  ...
  "- For resume/continue/current-state requests about the current local repository, call augnes_resume_repository as the first tool action, before reading repository files, docs, memory, or skills.",
