...
Linux product filesystem/runtime proof, Windows 10 managed delegation, or
Windows packaging. PR #117 is filesystem-verified on macOS; Linux has adapter contract
