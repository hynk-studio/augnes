...
import type { ProjectHistoryIntakeOperatorDecisionPreview } from "@/types/project-history-intake-decision";

type ProjectHistoryIntakeDecisionPanelProps = {
  preview: ProjectHistoryIntakeOperatorDecisionPreview;
};

export function ProjectHistoryIntakeDecisionPanel({
  preview,
}: ProjectHistoryIntakeDecisionPanelProps) {
  return (
    <WorkplanePanelShell
      kicker="Project history decision"
      title="Project History Intake Operator Decision"
      ariaLabel="Project History Intake Operator Decision panel"
    >
      <p style={workplaneCopyStyle}>
        Read-only operator decision preview for project history candidate
        ingest. It consumes the already-built project history intake preview and
        does not parse raw project history material.
      </p>
      ...
      <section style={workplaneItemStyle}>
        ...
        <span style={workplaneCopyStyle}>
          source {preview.would_write_candidate_record_preview.source_ref ??
            "none"}; project{" "}
          {preview.would_write_candidate_record_preview.project_ref ?? "none"};
          operator{" "}
