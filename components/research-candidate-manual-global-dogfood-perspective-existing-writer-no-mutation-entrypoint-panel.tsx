    ...
    >
      <div className="perspective-constellation-shell-header">
        <div>
          ...
          <p>
            ...
            and result artifact to a safe adapter-only no-op result. It refuses
            direct existing-writer targets and raw operator or credential-like
            inputs.
          </p>
        </div>
        <div className="perspective-constellation-shell-status">
          ...
          <span className="status-pill">
            writer_called{" "}
            {String(entrypointResult.execution_decision.existing_writer_called)}
          </span>
          <span className="status-pill">
            adapter_noop{" "}
            {String(
      ...
      <section className="cockpit-surface-card">
        ...
        <div className="perspective-workbench-status-row">
          ...
          <span>
            raw_payload_absent{" "}
            <code>{String(entrypointResult.validation.raw_payload_absent)}</code>
          </span>
        </div>
        <dl>
          {visibleRows.map((row) => (
