...
import type { HandoffPacketCopyExportContractOperatorDecisionPreview } from "@/types/handoff-packet-copy-export-contract-decision";
...
export function HandoffPacketCopyExportContractDecisionPanel({
  preview,
}: {
  preview: HandoffPacketCopyExportContractOperatorDecisionPreview;
}) {
  return (
    <section
      aria-label="Handoff Packet Copy Export Contract Decision"
      style={cardStyle}
    >
      <div>
      ...
      <p style={textStyle}>
        Operator decision preview only. It does not write records, copy/export
        packets, write files, write clipboard, download files, send handoff, or
      ...
      <p style={textStyle}>
        Entry count: {preview.input_summary.proposed_packet_entry_count}. Source
