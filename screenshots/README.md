...
- `01-overview-temporal-state-graph.png`: Overview tab with the five-tab Cockpit IA and Temporal State Graph visible.
...
- `12-final-cockpit-overview.png`: Actual Cockpit Overview showing the five-tab product flow and Temporal State Graph.
...
- `18-final-perspective-mobile.png`: Mobile Perspective screenshot showing the five-tab nav wrapping cleanly.
