...
function buildMockAutonomyContractPreviewRouteResponse(
  ...
  return {
    ...
    contract: {
      ...
      context_scope: {
        includes: ["GuideBrief preview", "Current Working Perspective", "Delta Projection"],
        excludes: ["Active runner state", "Active schedule", "Provider output", "Private account artifacts"],
      },
      allowed_agents: ["chatgpt", "codex"],
      allowed_surfaces: ["chatgpt_review", "agent_workplane_preview"],
      allowed_actions: [
      ...
      stop_conditions: [
        ...
        },
        {
          ...
          source_refs: ["docs/AUTONOMY_CONTRACT_V0_1.md"],
          blocks_future_run: true,
          recovery_hint: "Refresh the GuideBrief and active project sources.",
        },
        {
      ...
      review_escalation_policy: {
        ...
        requires_operator_review_when: [
          "stale GuideBrief or active project source",
          "budget exceeded",
      ...
      run_preview: {
        ...
        allowed_read_sources: ["GuideBrief preview", "Current Working Perspective", "Delta Projection"],
    ...
    source_status: {
      ...
      handoff_capsule: "retired_empty_compatibility_field",
      codex_launch_card: "retired_empty_compatibility_field",
...
export class MockStateRuntimeBridgeAdapter implements StateRuntimeBridgeAdapter {
  ...
  async getGuideBrief(input: { scope: StateRuntimeScope; projectId?: string }): Promise<GuideBriefResult> {
    const projectId = input.projectId ?? "project:00000000-0000-4000-8000-000000000001";
    const projectRef = "project:mock-current";
    const observedId = "observed:mock-current";
    const authority: GuideBriefResult["authority"] = {
      source_of_truth: false,
      can_commit_or_reject_state: false,
      can_record_proof: false,
      can_create_evidence: false,
      ...
      notes: ["GuideBrief is a View.", "Suggestions are not instructions."],
    };
    const primaryGuidance = {
      label: "Review result",
      reason: "A saved result needs user review.",
      href: "/workbench/semantic-review",
      action_ref: null,
      requires_user_judgment: true,
      source_refs: [projectRef],
    ...
    return {
      ...
      request: { scope: "project:augnes", route_mode: input.projectId ? "viewed_project" : "canonical", requested_project_id: input.projectId ?? null },
      identity: {
        workspace_id: "workspace:00000000-0000-4000-8000-000000000001",
        project_id: projectId,
        project_display_name: "Mock current project",
        project_context: input.projectId ? "viewed" : "current",
        active_project_id: "project:00000000-0000-4000-8000-000000000001",
        root_resolution: "available",
      },
      source_status: input.projectId ? "viewed_project" : "live_current_project",
      gaps: [],
      coordinate: {
        focus: "result_ready",
        goal: "Validate the current GuideBrief path",
        work_status: "Result ready for review",
        result_available: true,
        result_summary: "A bounded mock result is ready.",
        verification: { passed: 2, failed: 0, skipped: 0 },
      ...
      suggested: [{ item_id: "suggested:mock-current", label: primaryGuidance.label, reason: primaryGuidance.reason, href: primaryGuidance.href, action_ref: null, blockers: [], source_refs: [projectRef], executes: false }],
      needs_user_judgment: [{ item_id: "judgment:mock-current", question: "Should the result be accepted?", why_it_matters: "Only the user can settle this decision.", blocked: ["Project change"], source_refs: [projectRef], resolved: false }],
      primary_guidance: primaryGuidance,
      source_refs: [{ ref_id: projectRef, kind: "project", label: "Mock current project", href: "/" }],
      projections: {
        blank_state: {},
        ai_workplane: {},
        chatgpt: { summary: "A saved result is ready.", source_status: "live_current_project" },
        codex: {
          current_coordinate: "A result is ready",
          constraints: ["Do not approve automatically"],
      ...
      limits: { observed: 8, inferred: 4, suggested: 3, needs_user_judgment: 3, source_refs: 16, recent_changes: 3, text_bytes: 1024, serialized_bytes: 65536 },
    };
  }
