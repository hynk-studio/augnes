...
const requiredDocsPhrases = [
  ...
  "PR #870 historically selected `dogfooding_record_runtime_store_route_v0_1` for the non-UI implementation sequence.",
  "Dogfooding research record is candidate-only review material.",
  "This runtime only creates and reads candidate-only dogfooding research records through the same-origin route and caller-injected local DB helpers.",
  "UI/browser work remains outside this non-UI runtime",
