...
const workbenchPath = "app/workbench/page.tsx";
const publicHomePath = "components/augnes-public-home-surface.tsx";
const packagePath = "package.json";
const cssPath = "app/globals.css";
const smokePath = "scripts/smoke-perspective-public-surface-visual-reset-v0-1.mjs";
const publicSmokePath =
...
assert(
  home.includes("AugnesPublicHomeSurface"),
  "/ must render AugnesPublicHomeSurface in app/page.tsx",
);
assert(!home.includes("AugnesCockpit"), "/ must not render AugnesCockpit directly");
assert(workbench.includes("AugnesCockpit"), "/workbench must render AugnesCockpit");
...
function assertWorkbenchPointer(text) {
  ...
  assert(
    text.includes('href="/workbench"'),
    "Open cockpit workbench must use a normal internal anchor to /workbench",
  );
  assert(
