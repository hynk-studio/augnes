...
for (const fragment of [
  ...
  `receipt_stale_head`,
  `receipt_stale_integration_base`,
...
for (const fragment of [
  ...
  `current_main_base_equality_and_ancestry_admitted_before_planning`,
  `unavailable_current_main_has_no_tracking_ref_fallback`,
  `checkout_interprocess_exclusion_independent_of_companion`,
  `checkout_owner_stale_unsafe_and_foreign_cleanup_refused`,
  `quick_shared_typegen_coordinated`,
...
for (const fragment of [
  ...
  `integration_base_provenance_bound_and_reobserved`,
  `historical_receipts_not_upgraded`,
  `checkout_ownership_and_phase_lifetime_validated`,
