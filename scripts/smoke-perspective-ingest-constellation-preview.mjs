...
function assertOnlyManualGravityLocalDraftStorage(cockpitText) {
  ...
  assert.deepEqual(
    ...
    "Manual Gravity local draft must not introduce any new localStorage key",
  );
...
function assertCockpitSurface() {
  assertContainsAll(cockpitFile, [
    ...
    "Tensions",
    "Next steps",
    "Full refs and formation details",
    "Actions",
    "Open packet preview",
    "Temporal Underlay",
    "Temporal details",
    ...
    "Operator compact action review",
    "Now",
    "Needs user decision",
    "Ready to handoff",
    "Recent validation",
...
function assertManualGravityPreviewMarks() {
  ...
  assertContainsAll(cockpitFile, [
    ...
    "activeManualGravityPreviewConflictNotices",
    ...
    "manualGravityLocalDraftContextMismatches",
    "manualGravityLocalDraftMissingTargetKeys",
    "manualGravityLocalDraftRestoreNotice",
    "manualGravityDraftOverwritePending",
    "setManualGravityDraftOverwritePending",
    "manualGravityLocalDraftStatusLabel",
    "showManualGravityLocalDraftReceipt",
    "getManualGravityLocalDraftReceipt",
    ...
    "getManualGravityLocalDraftOverwriteReceipt",
    "commitManualGravityLocalDraft",
    "replaceManualGravityLocalDraftMarks",
    "cancelManualGravityLocalDraftOverwrite",
    "countManualGravityPreviewMarks",
    "countManualGravityPreviewTargets",
    "manualGravityPreviewMarkCount",
    "manualGravityPreviewTargetCount",
    "appliedGravityPreviewActive",
    "setAppliedGravityPreviewActive",
    "applyManualGravityPreview",
    "resetManualGravityPreviewApplication",
    "appliedGravityPreviewNodeMarksById",
    "appliedGravityPreviewNodeCount",
    "gravityPreviewNodeMarksById",
    "getManualGravityPreviewMarkClassName",
    "mergeManualGravityPreviewMarks",
    "Manual Gravity Preview",
    "Focus marks for this constellation",
    ...
    "Manual Gravity preview applied",
    "Manual Gravity Apply Preview actions",
    "Manual Gravity Apply Preview status",
    ...
    "marks",
    "notices",
    "Local visual emphasis only.",
    "Local visual emphasis only",
    "No automatic resolution",
    "No source graph changes.",
    "No source graph changes",
    "No FormationReceiptV0 authority change.",
    "No FormationReceiptV0 authority change",
    ...
    "Manual Gravity Local Draft badge",
    ...
    "Local draft:",
    "Local draft: {manualGravityLocalDraftStatusLabel}",
    "local draft",
    "none",
    "unsaved preview marks",
    "saved for this formation",
    "restored from browser metadata",
    "no matching draft",
    "unavailable",
    "Browser-local mark metadata only.",
    "Browser-local metadata only",
    "non-authoritative",
    "no raw",
    "content stored",
...
function assertCssHooks() {
  assertContainsAll(cssFile, [
    ...
    "perspective-manual-gravity-apply-actions",
    "perspective-manual-gravity-applied-state",
    "perspective-manual-gravity-applied-legend",
    ...
    "perspective-manual-gravity-local-draft-badge",
    "perspective-manual-gravity-restore-notice",
    "perspective-manual-gravity-overwrite-confirmation",
    "perspective-manual-gravity-local-draft-receipt",
    "perspective-manual-gravity-draft-actions",
    "perspective-manual-gravity-overwrite-actions",
    "perspective-preview-overrides-draft-note",
    "perspective-preview-overrides-gravity-applied-note",
    "is-gravity-preview-marked",
    "is-gravity-preview-pinned",
    "is-gravity-preview-watched",
    "is-gravity-preview-deferred",
    "is-gravity-preview-boosted",
    "gravity-preview-node-badge",
    ...
    "perspective-event-rail-node[aria-pressed=\"true\"]",
