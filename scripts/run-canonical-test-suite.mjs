...
const suites = {
  ...
  integration: [
    ...
    {
      id: "settled-expired-successor",
      group: "supporting-serial",
      requirements: ["database", "migrations", "filesystem", "mutable-module-state", "process-owning"],
      label: "settled failed result, expired history and explicit revalidated task authorship",
      ...rootNode("scripts/test-vnext-project-work-initialization.ts", "--settled-expired-successor-only"),
      timeoutMs: 30_000,
      requireNaturalExit: true,
    },
    {
      id: "settled-expired-successor-refusals",
      group: "supporting-serial",
      requirements: ["database", "migrations", "filesystem", "mutable-module-state", "process-owning"],
      label: "expired successor settlement, lifetime, material and authority refusals",
      ...rootNode("scripts/test-vnext-project-work-initialization.ts", "--settled-expired-successor-refusals-only"),
      timeoutMs: 30_000,
      requireNaturalExit: true,
    },
    {
