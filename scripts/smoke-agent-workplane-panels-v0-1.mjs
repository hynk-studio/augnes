...
const followOnHandoffContextUpdateContractFiles = [
...
const followOnHandoffPacketCopyExportContractFiles = [
...
const followOnHandoffPacketCopyExportSliceFiles = [
...
const allowedChangedFiles = new Set([
  ...
  ...followOnHandoffPacketCopyExportContractFiles,
  ...followOnHandoffPacketCopyExportSliceFiles,
...
for (const file of followOnResearchCandidateManualNoteHandoffSeedFiles) {
  allowedChangedFiles.add(file);
}
...
for (const file of followOnResearchCandidateManualGlobalDogfoodMetricSnapshotWriteFiles) {
  allowedChangedFiles.add(file);
}
...
for (const file of followOnResearchCandidateManualGlobalDogfoodNextWorkSignalWriteFiles) {
  allowedChangedFiles.add(file);
}
...
for (const file of followOnResearchCandidateManualGlobalDogfoodActionContractFiles) {
  allowedChangedFiles.add(file);
}
...
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveRelayWriteFiles) {
  allowedChangedFiles.add(file);
}
...
for (const file of followOnResearchCandidateManualGlobalDogfoodCanonicalPerspectiveUpdateContractFiles) {
  allowedChangedFiles.add(file);
}
...
for (const file of followOnResearchCandidateManualGlobalDogfoodCanonicalPerspectiveUpdateWriteFiles) {
  allowedChangedFiles.add(file);
}
...
const followOnResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteFiles = [
  "lib/db/schema.sql",
  "lib/db.ts",
  "scripts/db-migrations.mjs",
  "scripts/db-migrate.mjs",
  ...
  "components/research-candidate-manual-global-dogfood-perspective-apply-contract-panel.tsx",
  "docs/RESEARCH_CANDIDATE_REVIEW_SURFACE_V0_1.md",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-apply-write-v0-1.mjs",
  "scripts/smoke-human-surface-home-v0-1.mjs",
  "scripts/smoke-agent-workplane-panels-v0-1.mjs",
  "package.json",
];
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteFiles) {
  allowedChangedFiles.add(file);
}
...
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveStateMutationContractFiles) {
  allowedChangedFiles.add(file);
}

const followOnResearchCandidateManualGlobalDogfoodPerspectiveStateMutationWriteFiles = [
  "lib/db/schema.sql",
  "lib/db.ts",
  "scripts/db-migrations.mjs",
  "scripts/db-migrate.mjs",
  ...
  "components/research-candidate-manual-global-dogfood-perspective-state-mutation-contract-panel.tsx",
  "docs/RESEARCH_CANDIDATE_REVIEW_SURFACE_V0_1.md",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-state-mutation-write-v0-1.mjs",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-state-mutation-contract-v0-1.mjs",
  "scripts/smoke-human-surface-home-v0-1.mjs",
  "scripts/smoke-agent-workplane-panels-v0-1.mjs",
  "package.json",
];
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveStateMutationWriteFiles) {
  allowedChangedFiles.add(file);
}

const followOnResearchCandidateManualGlobalDogfoodPerspectiveAdapterContractFiles = [
...
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveAdapterContractFiles) {
  allowedChangedFiles.add(file);
}

const followOnResearchCandidateManualGlobalDogfoodPerspectiveAdapterWriteFiles = [
  "lib/db/schema.sql",
  "lib/db.ts",
  "scripts/db-migrations.mjs",
  "scripts/db-migrate.mjs",
  ...
  "components/research-candidate-manual-global-dogfood-perspective-adapter-contract-panel.tsx",
  "docs/RESEARCH_CANDIDATE_REVIEW_SURFACE_V0_1.md",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-adapter-write-v0-1.mjs",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-adapter-contract-v0-1.mjs",
  "scripts/smoke-human-surface-home-v0-1.mjs",
  "scripts/smoke-agent-workplane-panels-v0-1.mjs",
  "package.json",
];
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveAdapterWriteFiles) {
  allowedChangedFiles.add(file);
}

const followOnResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationContractFiles = [
...
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationContractFiles) {
  allowedChangedFiles.add(file);
}

const followOnResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationWriteFiles = [
  "lib/db/schema.sql",
  "lib/db.ts",
  "scripts/db-migrations.mjs",
  "scripts/db-migrate.mjs",
  ...
  "components/research-candidate-manual-global-dogfood-perspective-state-application-contract-panel.tsx",
  "docs/RESEARCH_CANDIDATE_REVIEW_SURFACE_V0_1.md",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-state-application-write-v0-1.mjs",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-state-application-contract-v0-1.mjs",
  "scripts/smoke-human-surface-home-v0-1.mjs",
  "scripts/smoke-agent-workplane-panels-v0-1.mjs",
  "package.json",
];
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationWriteFiles) {
  allowedChangedFiles.add(file);
}

const followOnResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityContractFiles = [
...
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityContractFiles) {
  allowedChangedFiles.add(file);
}

const followOnResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityWriteFiles = [
  "lib/db/schema.sql",
  "lib/db.ts",
  "scripts/db-migrations.mjs",
  "scripts/db-migrate.mjs",
  ...
  "components/research-candidate-manual-global-dogfood-perspective-writer-compatibility-contract-panel.tsx",
  "docs/RESEARCH_CANDIDATE_REVIEW_SURFACE_V0_1.md",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-writer-compatibility-write-v0-1.mjs",
  "scripts/smoke-research-candidate-manual-global-dogfood-perspective-writer-compatibility-contract-v0-1.mjs",
  "scripts/smoke-human-surface-home-v0-1.mjs",
  "scripts/smoke-agent-workplane-panels-v0-1.mjs",
  "package.json",
];
for (const file of followOnResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityWriteFiles) {
  allowedChangedFiles.add(file);
}
  ...
  for (const file of files) {
    ...
    assert(
      !/^app\/api\//.test(file) ||
        ...
        followOnResearchCandidateManualGlobalDogfoodPerspectiveApplyWriteFiles.includes(file) ||
        followOnResearchCandidateManualGlobalDogfoodPerspectiveStateMutationWriteFiles.includes(file) ||
        followOnResearchCandidateManualGlobalDogfoodPerspectiveAdapterWriteFiles.includes(file) ||
        followOnResearchCandidateManualGlobalDogfoodPerspectiveStateApplicationWriteFiles.includes(file) ||
        followOnResearchCandidateManualGlobalDogfoodPerspectiveWriterCompatibilityWriteFiles.includes(file),
